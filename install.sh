...
say "1/6  Repo config (mirror + xbps.d), then sync"
...
say "3/6  Symlink dotfiles with stow (config, home, local)"
...
say "5/6  Curated /etc files (tlp, lightdm)"
